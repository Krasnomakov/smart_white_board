...
def read_all_sensors():
    ...
    # ---------------------------------------------------------------------
    # This extra line is the SPECIAL MARKER you wanted for data logging:
    usb_cdc.console.write("<START_OF_LOG>\n".encode())
    # ---------------------------------------------------------------------
    ...
    # Append the existing end-of-data marker
...
def main():
    ...
    global last_position_left, last_position_right
