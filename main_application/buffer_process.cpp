                    ...
                    if (!isLineEmpty(line)) {
                        ...
                        if (strstr(line, "<END_OF_DATA>") == NULL) {
                            ...
                            // Check for sensor-like lines
                                ...
                                // Log to data_logs and forward to modes
